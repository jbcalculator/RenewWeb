...
var money = 0;
    while (rlevel > 0) {
        ...
        if (clevel >= 0 && clevel < 25) {
            ...
            money+=8.5;
            // return 8.5f;
        } else if (clevel >= 400 && clevel < 425) {
            clevel++;
            rlevel--;
            money+=9;
            // return 9f;
        } else if (clevel >= 425 && clevel < 450) {
            clevel++;
            rlevel--;
            money+=9.5;
            // return 9.5f;
        } else if (clevel >= 450 && clevel < 475) {
            clevel++;
            rlevel--;
            money+=10;
            // return 10f;
        } else if (clevel >= 475 && clevel < 500) {
            clevel++;
            rlevel--;
            money+=10.5;
            //  return 10.5f;
        } else if (clevel >= 500 && clevel < 525) {
            clevel++;
            rlevel--;
            money+=11;
            //  return 11f;
        } else if (clevel >= 525 && clevel < 550) {
            clevel++;
            rlevel--;
            money+=11.5;
            // return 11.5f;
        } else if (clevel >= 550 && clevel < 575) {
            clevel++;
            rlevel--;
            money+=12;
            // return 12f;
        } else if (clevel >= 575 && clevel < 600) {
            clevel++;
            rlevel--;
            money+=12.5;
            // return 12.5f;
